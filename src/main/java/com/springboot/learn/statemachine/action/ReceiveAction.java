 ...
 * Date: 2020-09-08
 */
@Component("receiveAction")
public class ReceiveAction implements Action<OrderStatusEnum, OrderStatusChangeEventEnum> {
    @Override
    public void execute(StateContext<OrderStatusEnum, OrderStatusChangeEventEnum> stateContext) {
        System.out.println("receiveAction execute");
